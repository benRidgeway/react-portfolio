...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Forrest Ridgeways Portfolio</title>
        ...
        <section className="min-h-screen">
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800'>
              ...
              I cant wait to get into the field and get to work. Being fresh out of the FullStack certication program, I know I have a lot to learn, and would feel more comfortable
